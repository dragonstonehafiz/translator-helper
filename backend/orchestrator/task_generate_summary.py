...
from prompts.context import generate_summary_prompt
from utils.utils import load_sub_data

logger = setup_logger("task-timings")


class TaskGenerateSummary(BaseTask):
    TASK_TYPE = "TaskGenerateSummary"
